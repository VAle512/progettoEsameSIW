      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              <div class="row">
                  <div class="col-xs-6">
                      <div class="well">
                      <h3>L'email inserita è gia stata utilizzata. Provi a fare il login oppure a registrarsi con una nova email.</h3>
                              ...
                              <h:commandButton action = "#{customerController.checkLogin}" value="Login" > </h:commandButton>
                              
                              
                               <h:commandButton action = "#{customerController.helpToLogin}" value="Help to Login" > </h:commandButton>
                  ...
                  <div class="col-xs-6">
                      ...
                      <p><a href="http://localhost:8080/progettoEsameSIW/faces/newCustomer.jsp" class="btn btn-info btn-block">Yes please, register now!</a></p>
                  </div>
              </div>
          </div>
      </div>
