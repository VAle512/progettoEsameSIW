...
<h:form>
	...
	<div>Storage Quantity: <h:inputText value="#{productController.storageQuantity}" 
                     required="true"
                     requiredMessage="Storage Quantity is mandatory"
                     converterMessage="Storage Quantity must be a number"
                     id="storageQuantity"/> <h:message for="storageQuantity" />
    </div>
	<div>
